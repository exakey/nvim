-- EDITOR
vim.cmd(" highlight MatchParen guifg=#f38ba8 guibg=#1e1e2e gui=bold ")
vim.cmd(" highlight CursorLine guifg=NONE    guibg=NONE ")
vim.cmd(" highlight IncSearch  guifg=#11111b guibg=#f38ba8 ")
vim.cmd(" highlight Visual     guifg=NONE    guibg=#181825 gui=bold ")
-- vim.cmd(" highlight Visual     guifg=#11111b guibg=#f38ba8 ")
